...
pub const CLAIM_VAULT_DISCRIMINATOR: [u8; 8] = [87, 111, 176, 185, 53, 172, 227, 137];
...
/// runtime `require!` checks on nominee_ata.mint and nominee_ata.owner.
          ...
          pub nominee_ata: solana_pubkey::Pubkey,
...
impl ClaimVault {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&ClaimVaultInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct ClaimVaultInstructionData {
            discriminator: [u8; 8],
      }

impl ClaimVaultInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [87, 111, 176, 185, 53, 172, 227, 137],
                  }
  }
}

impl Default for ClaimVaultInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `ClaimVault`.
///
/// ### Accounts:
///
...
pub struct ClaimVaultBuilder {
            nominee: Option<solana_pubkey::Pubkey>,
                ...
                nominee_ata: Option<solana_pubkey::Pubkey>,
...
/// runtime `require!` checks on nominee_ata.mint and nominee_ata.owner.
#[inline(always)]
    pub fn nominee_ata(&mut self, nominee_ata: solana_pubkey::Pubkey) -> &mut Self {
                        self.nominee_ata = Some(nominee_ata);
                    self
    }
            /// Vault's Associated Token Account — holds the staked tokens.
/// 
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = ClaimVault {
                              nominee: self.nominee.expect("nominee is not set"),
                                        ...
                                        nominee_ata: self.nominee_ata.expect("nominee_ata is not set"),
...
/// runtime `require!` checks on nominee_ata.mint and nominee_ata.owner.
              ...
              pub nominee_ata: &'b solana_account_info::AccountInfo<'a>,
                        /// Vault's Associated Token Account — holds the staked tokens.
/// 
/// LOOPHOLE-1 FIX: `associated_token::authority = vault` means the vault
/// PDA is the SOLE authority over this ATA.  The nominee (or anyone else)
...
impl<'a, 'b> ClaimVaultCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: ClaimVaultCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
              ...
              mint: accounts.mint,
              nominee_ata: accounts.nominee_ata,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.nominee.clone());
                        ...
                        account_infos.push(self.nominee_ata.clone());
...
/// Instruction builder for `ClaimVault` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` nominee
...
impl<'a, 'b> ClaimVaultCpiBuilder<'a, 'b> {
...
/// runtime `require!` checks on nominee_ata.mint and nominee_ata.owner.
#[inline(always)]
    pub fn nominee_ata(&mut self, nominee_ata: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.nominee_ata = Some(nominee_ata);
                    self
    }
      /// Vault's Associated Token Account — holds the staked tokens.
/// 
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          nominee_ata: self.instruction.nominee_ata.expect("nominee_ata is not set"),
...
struct ClaimVaultCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_account_info::AccountInfo<'a>,
            nominee: Option<&'b solana_account_info::AccountInfo<'a>>,
                ...
                nominee_ata: Option<&'b solana_account_info::AccountInfo<'a>>,
